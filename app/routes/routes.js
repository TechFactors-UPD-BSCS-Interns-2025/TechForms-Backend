...
const { BookingDetailsRoutes } = require("./booking_details/booking_details_routes");const { UserCredentialsRoutes } = require("./user_credentials/user_credentials_routes");
